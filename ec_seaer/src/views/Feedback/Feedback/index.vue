<template>
    <div class="app">
        <v-navigation title="Feedback"></v-navigation>

        <form class="main" action="" method="">
            <v-scroll :obj="obj">
                ...
                <section class="main-item">
                    ...
                    <div class="main-item-list">
                        ...
                        <input
                            name="phone"
                            placeholder="Please enter your Phonee"
                            type="text">
                    </div>
                </section>
                ...
                <section class="main-item">
                    ...
                    <div class="main-item-textarea">
                        ...
                        <span v-text="message.length + '/1000'"></span>
                    </div>
                </section>
                ...
                <button class="main-sub" type="button" @click="$router.push('/Feedback/Success')">Submit</button>
            </v-scroll>
        </form>
    </div>
</template>
